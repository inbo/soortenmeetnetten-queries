...
planten_update_orig <- read_excel(file.path(data_path, "exportplantenmeetnet2022_oplevering22december.xlsx"))
...
st_write(tracks, "../output/controle_plantendata/tracks_planten", driver = "ESRI Shapefile")
```
