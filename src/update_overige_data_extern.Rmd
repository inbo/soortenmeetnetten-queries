...
data_path <- "G:/Mijn Drive/Soortenmeetnetten/Oplevering data/2024/Data niet in Meetnetten.be/Hamster - Oplevering data Meetnetten 2024"

burchten_nieuw_sf <- read_sf(data_path, "Meetnet Hamster_2024_waarnemingen",
                             crs = 31370)
...
percelen_update_sf_orig <- read_sf(data_path, "Meetnet Hamster_2024_percelen")
