...
Sommige burchten worden meermaals bezocht in een jaar.
De datum van het bezoek zal nog worden toegevoegd aan de dataset.

Het is mogelijk dat binnen hetzelfde jaar de status van de burcht wijzigt (bij meerdere bezoeken per jaar).
